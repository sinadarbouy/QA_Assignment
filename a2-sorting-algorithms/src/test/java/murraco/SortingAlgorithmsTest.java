...
public class SortingAlgorithmsTest {
  ...
  @Test
  public void testBubbleSortWithDuplicate_Number() {
  ...
  @Test
  public void testBubbleSortWithoneData() {
    final Integer[] oneData = { 1 };
    final Integer[] emptyData = {};
    BubbleSort.bubbleSort(oneData);
    BubbleSort.bubbleSort(emptyData);
    assertEquals("[1]", Arrays.toString(oneData));
